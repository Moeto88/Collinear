...
public class CollinearTest
{
    ...
    public void testBinarySearch()
    {
        ...
        assertEquals("binarySearch(" + Arrays.toString(a) + ", " + key + ")",  expectedResult, Collinear.binarySearch(a, key));
    }
    
    @Test
    public void testSort()
    {
        int[] a = {18, 13, 16, 27, 3, 6, 10, 4, 15};
        
        int[] result = {3, 4, 6, 10, 13, 15, 16, 18, 27};
        ...
        for(int i = 0; i < a.length; i++)
        {
        	...
        	assertEquals("sort(" + Arrays.toString(a) + ")",  expectedResult, value);
        }  
    }
